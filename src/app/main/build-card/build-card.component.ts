...
export class BuildCardComponent implements OnChanges {
  ...
  ngOnInit() {
    ...
    this.porcentagemAndamento =
      this.estimativaService.getAndamentoPorcentagem();

    this.porcentagemFinalizado =
      this.estimativaService.getFinalizadoPorcentagem();
  ...
  changetoandamento(indice) {
    ...
    this.changeColumn.changetoandamento(
      this.cards,
      indice,
      this.cardsandamento
    );
  ...
  changetofinalizado(indice) {
    ...
    this.changeColumn.changetofinalizado(
      this.cards,
      indice,
      this.cardsfinalizado
    );
  ...
  botUpDown() {
    this.botafazer = this.botCardFocus.cardtestafazer(
      this.cardsafazer,
      this.botafazer
    );
    this.botandamento = this.botCardFocus.cardtestandamento(
      this.cardsandamento,
      this.botandamento
    );
    this.botfinalizado = this.botCardFocus.cardtestfinalizado(
      this.cardsfinalizado,
      this.botfinalizado
    );
  }
