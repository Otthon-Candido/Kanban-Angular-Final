...
export class MainComponent {
  ...
  estimativaModalColuna(coluna:string){
    ...
    switch(coluna){
      ...
      case 'A FAZER':    if(this.varColunaEstimativaAfazer){
      ...
      case 'EM ANDAMENTO':    if(this.varColunaEstimativaAndamento){
      ...
      case 'FINALIZADO':    if(this.varColunaEstimativaFinalizado){
